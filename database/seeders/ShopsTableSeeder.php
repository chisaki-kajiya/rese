...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'image_path' => 'storage/shop/sushi.jpeg',
            'area_id' => 1,
            'genre_id' => 1,
        ];
        Shop::create($param);
        ...
        $param = [
            ...
            'image_path' => 'storage/shop/yakiniku.jpeg',
            'area_id' => 2,
            'genre_id' => 2,
        ];
        Shop::create($param);
        ...
        $param = [
            ...
            'image_path' => 'storage/shop/izakaya.jpeg',
            'area_id' => 3,
            'genre_id' => 3,
        ];
        Shop::create($param);
        ...
        $param = [
            ...
            'image_path' => 'storage/shop/italian.jpeg',
            'area_id' => 1,
            'genre_id' => 4,
        ];
        Shop::create($param);
        ...
        $param = [
            ...
            'image_path' => 'storage/shop/ramen.jpeg',
            'area_id' => 3,
            'genre_id' => 5,
        ];
        Shop::create($param);
